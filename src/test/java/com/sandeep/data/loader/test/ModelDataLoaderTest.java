package com.sandeep.data.loader.test;
...
import com.sandeep.utils.MLProperties;
...
public class ModelDataLoaderTest {
	...
	public void loadDatas() {
		...
		delta = 0;
		logger.info("Loaded datas for testing com.sandeep.data.loader.ModelDataLoader");
	...
	public void loadModelDatasTest() {
		...
		logger.info("Completed Test case for com.sandeep.data.loader.ModelDataLoader.loadModelDatas");
	...
	public void loadDatasForTrainingTest() {
		...
		logger.info("Completed Test case for com.sandeep.data.loader.ModelDataLoader.loadDatasForTraining(");
